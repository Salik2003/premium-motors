...
import { Plus, Edit2, Trash2, ExternalLink, Search, Filter, AlertCircle } from 'lucide-react'
                                ...
                                <tr key={car.id} className="group hover:bg-slate-50/50 dark:hover:bg-white/5 transition-all duration-300">
                                    ...
                                    <td className="px-10 py-8 text-right">
                                        <div className="flex items-center justify-end gap-3">
                                            ...
                                            <button className="p-3 bg-slate-50 dark:bg-white/5 text-slate-400 hover:text-brand-gold hover:bg-white dark:hover:bg-white/10 hover:shadow-lg rounded-xl transition-all">
