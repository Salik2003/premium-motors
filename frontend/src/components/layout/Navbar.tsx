...
export const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-[100] border-b border-slate-100 bg-white md:bg-white/90 md:backdrop-blur-md px-4 md:px-12 py-3 flex items-center justify-between transition-all duration-300">
            <Link to="/" className="flex items-center gap-4 group relative z-[110]" data-aos="fade-right">
                <div className="w-12 h-12 md:w-16 md:h-16 transition-transform duration-500 group-hover:scale-110">
                    <img src={pmLogo} alt="Premium Motors Logo" className="w-full h-full object-contain" />
                </div>
                <div className="flex flex-col">
                    <span className="text-base md:text-xl font-serif font-black tracking-[0.1em] text-brand-dark leading-none uppercase">PREMIUM</span>
                    <span className="text-[8px] md:text-[11px] font-bold tracking-[0.3em] text-brand-gold uppercase leading-none mt-1.5">Motors</span>
                </div>
            </Link>
